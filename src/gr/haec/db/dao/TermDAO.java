...
public class TermDAO extends BaseDAO<Term> {
	...
	public TermDAO(Connection conn) throws SQLException {
		...
		insertStatement = dbConnection.prepareStatement("INSERT INTO WP_TERMS(name, slug, term_group) VALUES(?, ?, ?);");
	}
	...
	@Override
	public boolean insert(Term dto) {
		
		try {
			insertStatement.setString(1, dto.getTermName());
			insertStatement.setString(2, dto.getTermSlug());
			insertStatement.setInt(3, dto.getTermGroup());
